...
function loadInstagram() {
  var $list = (0, _helper.$)('.instagram-list');
  fetch('https://api.instagram.com/v1/users/self/media/recent/?access_token=38879863.d1ca157.372823cf31b5429bbd6863d84db75635').then(function (response) {
...
},{"./helper":5,"whatwg-fetch":2}],7:[function(require,module,exports){
"use strict";
...
},{"./add-emoji-title":3,"./add-github-stats":4,"./helper":5,"./instagram":6,"./scrollex":8,"./set-current-year":9,"./set-navigation-state":10,"fontfaceobserver":1}],8:[function(require,module,exports){
"use strict";
