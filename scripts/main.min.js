...
var listed = ['tetrys', 'frontbook', 'domtimer', 'chrome-gist-word-count'];
...
function insertStarCount($wrapper, repo) {
	...
	var $starsEl = $wrapper.querySelector('.project-' + name + ' .project-stars');
	if (!$starsEl) return;
...
function addCreatedDate($wrapper, repo) {
	...
	var $headline = $wrapper.querySelector('.project-' + name + ' h3');
	if (!$headline) return;
