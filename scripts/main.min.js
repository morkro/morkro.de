...
var AnchoredHeadline = function () {
	function AnchoredHeadline(container) {
		_classCallCheck(this, AnchoredHeadline);
	...
	_createClass(AnchoredHeadline, [{
		...
		key: 'getAll',
		value: function getAll(list) {
			var _this = this;

			list.forEach(function (tag) {
				var elem = _this.container.getElementsByTagName(tag);
				for (var i = elem.length; i--;) {
					_this.createLink(elem[i]);
				}
			});
		}
	}, {
		key: 'createLink',
		value: function createLink(elem) {
			var link = document.createElement('a');
			var sign = document.createTextNode(this.anchorSign);
	...
	return AnchoredHeadline;
}();

exports.default = AnchoredHeadline;
...
var _currentPage = require('./current-page');
...
var _anchoredHeadlines = require('./anchored-headlines');

var _anchoredHeadlines2 = _interopRequireDefault(_anchoredHeadlines);
...
// PAGE SPECIFIC
if ((0, _currentPage2.default)('about')) {
	var mapConfig = {
		map: (0, _helper.$)('#map'),
...
} else if ((0, _currentPage2.default)('article')) {
	var anchor = new _anchoredHeadlines2.default((0, _helper.$)('.article-body'));
	anchor.init();
}

},{"./anchored-headlines":1,"./current-page":2,"./helper":3,"./highlight-svg-map":4,"./scrollex":6,"./set-current-year":7,"./set-navigation-state":8}],6:[function(require,module,exports){
'use strict';
...
},{"./helper":3}],7:[function(require,module,exports){
'use strict';
