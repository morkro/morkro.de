...
var nextCity = (0, _helper.$)('.travels-nextcity');

function highlightCountry(event) {
   var color = '#ff7c00';
   var country = (0, _helper.$)('#map ' + nextCity.getAttribute('data-area'));
   console.log(event);
...
},{"./helper":1,"./scrollto":3,"./set-current-year":4,"./set-navigation-state":5}],3:[function(require,module,exports){
'use strict';
