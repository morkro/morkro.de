...
function highlightSVGMap() {
   ...
   var country = map.querySelector('' + trigger.getAttribute(config.attr));
   ...
   trigger.addEventListener('mouseover', highlight, false);
   trigger.addEventListener('mouseleave', highlight, false);
}
...
// GENERAL
(0, _setNavigationState2.default)({
...
},{"./helper":1,"./highlight-svg-map":2,"./scrollto":4,"./set-current-year":5,"./set-navigation-state":6}],4:[function(require,module,exports){
'use strict';
...
var moveToSection = function moveToSection(event) {};
...
exports.default = setCurrentYear;
